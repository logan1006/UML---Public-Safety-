...
class ChartConfig{
	...
	LineChart(chartType){
		...
		case "crimeDataLineChart":
				...
				new Line().createCanvas(fileName,10,9,chartType);
				break;
		case "policeStationLineChart":
				var fileName = "Police_Stations.csv";
				new Line().createCanvas(fileName,10,11,chartType);
				break;
	...
	BarChart(chartType){
		...
		case "crimeDataBarChart":
				var fileName = "CrimePriorData.csv";
				new Bar().createCanvas(fileName,10,9,chartType);
		break;
		case "policeStationBarChart":
				var fileName = "Police_Stations.csv";
				new Bar().createCanvas(fileName,5,11,chartType);
		break;
	...
	case "crimeDataPieChart":
			var fileName = "CrimePriorData.csv";
			new Pie().createCanvas(fileName,10,9,chartType);
	break;
	case "policeStationPieChart":
			var fileName = "Police_Stations.csv";
			new Pie().createCanvas(fileName,1,10,chartType);
	break;
	...
	PolarChart(chartType){
		...
		case "crimeDataPolarChart":
				var fileName = "CrimePriorData.csv";
				new Polar().createCanvas(fileName,10,9,chartType);
		break;
		case "policeStationPolarChart":
				var fileName = "Police_Stations.csv";
				new Polar().createCanvas(fileName,0,11,chartType);
		break;
	...
	DoughnutChart(chartType){
		...
		case "crimeDataDoughnutChart":
				var fileName = "CrimePriorData.csv";
				new Doughnut().createCanvas(fileName,10,9,chartType);
		break;
